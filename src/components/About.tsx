...
export default function About() {
  return (
    <section id="about" className="py-12 sm:py-16 lg:py-24 px-4 sm:px-6 lg:px-8 bg-linear-to-b from-black to-zinc-900">
        ...
        <div className="grid md:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center mb-12 sm:mb-16">
          ...
          <div className="space-y-4 sm:space-y-6 order-1 md:order-2">
            <p className="text-base sm:text-lg text-gray-300 leading-relaxed font-light">
              For six years, <span className="text-amber-400 font-medium">The Select Match</span> has operated as Kenya's most discreet matchmaking service, connecting successful professionals through private networks and personal referrals.
            </p>

            <p className="text-base sm:text-lg text-gray-300 leading-relaxed font-light">
              We understand that accomplished individuals value their time, privacy, and the quality of their connections. Our white-glove approach eliminates the frustration of modern dating apps, offering instead a refined experience built on trust, verification, and personal attention.
            </p>

            <div className="space-y-3 sm:space-y-4 pt-4">
              <Feature text="Fully vetted and verified members" />
              <Feature text="Curated introductions based on compatibility" />
              <Feature text="First dates at premium venues — arranged and paid for" />
              <Feature text="Dedicated matchmaker guidance throughout" />
              <Feature text="Complete discretion and confidentiality" />
            </div>
          </div>
        </div>

        <div className="bg-linear-to-br from-amber-500/10 to-rose-500/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 border border-amber-500/20 backdrop-blur-sm">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <WhoWeServeCard 
              ...
              description="Busy leaders seeking meaningful connections without compromising their valuable time"
            />
            <WhoWeServeCard 
              title="Entrepreneurs & HNWIs"
              description="Successful individuals valuing privacy, quality, and intentional relationships"
            />
            <WhoWeServeCard 
              title="Those Seeking Authenticity"
              description="Discerning singles tired of superficial apps, ready for real connection"
            />
          </div>
        </div>
      </div>
